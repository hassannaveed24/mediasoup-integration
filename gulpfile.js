...
gulp.task('watch', (done) => {
	...
	gulp.watch(['public/index.html'], gulp.series(
		'html'
	));
	...
	gulp.watch(['gulpfile.js', 'src/**/*.js', 'src/**/*.jsx'], gulp.series(
		'lint'
	));
...
gulp.task('live', gulp.series(
	'browser:base',
	(done) => {
		const config = require(CONFIG_DIR);
		...
		browserSync(
			{
				...
				https: config.https.tls,//certificate
				ghostMode: false
