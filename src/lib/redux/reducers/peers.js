...
const initialState = {};
const logger = new Logger('reducers/peers');
		...
		case 'SET_TEMPERATURE':
			{
				...
				logger.debug('SET_TEMPERATURE');

				const { temperature, peerId } = action.payload;
				...
				if (!peer)
					throw new Error('no Peer found for peerId');

				const newPeer = { ...peer, temperature };
